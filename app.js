...
let SESSION_TOKEN =
sessionStorage.getItem('CAS_ACTIVE_JWT') || null;

let USER_ROLE =
sessionStorage.getItem('CAS_ACTIVE_ROLE') || null;
...
async function appendChapterPrompt(
    subject_id
) {
...
async function appendThemePrompt(
    chapter_id
) {
